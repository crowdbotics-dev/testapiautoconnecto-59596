...
## Project Structure
    ...
    ├── testapiautoconnecto_59596  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_59596`
...
2. Clone this repo and `cd testapiautoconnecto_59596`
